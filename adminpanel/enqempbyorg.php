...
<table width="427" height="159" border="1" align="center">
  <tr>
    <th height="36" colspan="2" scope="col">Employee information by organisation </th>
    </tr>
  <tr>
    <td>Enter organisation name </td>
    <td><input name="emporg" type="text" id="emporg" value=""></td>
  </tr>
  <tr>
...
<p>&nbsp;</p>
  ...
  <?php 
	...
	$rs=mysqli_query($con,"select * from empinfo where emporg='$emporg'");
